...
uses
  ...
  Menus,LazFileUtils, LCLProc, LazUtils, LazUtf8, Variants, strutils, RichMemo;
...
//This function must be rewritten including proper character calculation in UTF8
//Seems to that it counts one character less
begin
